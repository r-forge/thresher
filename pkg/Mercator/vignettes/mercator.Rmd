...
```
The two larges groups get assigned the same colors (by chance) in the Jaccard and the
...
```
If the number of colors in the palette is smaller thant he numbe of clusters,
