...
## Simulate Data
Now we can take a random sample of 150 elements from the distribution that we just defined.
```{r simData}
trueN <- 150
...
y <- suppressWarnings( RangeSillyPutty(dis, start = 2, end = 12, method = "HCSP") )
